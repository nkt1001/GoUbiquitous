...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    private static final String WEATHER_PATH = "/wearable_data";
    ...
    private void updateWearable(){
        ...
        if (cursor.moveToFirst()) {
            ...
            mExecutor.execute(new SendToDataLayerThread(WEATHER_PATH, dataMap));
        }
    }



    private class SendToDataLayerThread implements Runnable {
        String path;
        DataMap dataMap;
